...
int main()
{
	...
	char name[50] = "Hello";
	serv.sin_family = AF_INET;            //использование айпи-адресации
	serv.sin_port = htons(2000);          //порт
	serv.sin_addr.s_addr = INADDR_ANY;   //любой собственный айпи
	...
	char hostname[25];
	hostent* clntInfo;
	memset(&clntInfo, 0, sizeof(clntInfo)); //обнулить память
